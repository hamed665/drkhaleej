  ...
  public: {
    Tables: {
      ...
      landing_page_contents: {
        Row: {
          area_id: string | null
          canonical_area_key: string | null
          canonical_landing_key: string
          city_id: string | null
          country_code: Database["public"]["Enums"]["country_code"]
          created_at: string
          created_by_profile_id: string | null
          deleted_at: string | null
          editorial_review_status: Database["public"]["Enums"]["landing_editorial_review_status"]
          family: Database["public"]["Enums"]["landing_page_family"]
          faq: Json | null
          id: string
          intro: string | null
          is_medical: boolean
          locale: Database["public"]["Enums"]["app_locale"]
          medical_review_status: Database["public"]["Enums"]["landing_medical_review_status"]
          ...
          service_id: string | null
          specialty_id: string | null
          status: Database["public"]["Enums"]["landing_content_status"]
          title: string | null
          updated_at: string
        ...
        Relationships: [
          {
            foreignKeyName: "landing_page_contents_area_id_fkey"
            columns: ["area_id"]
            isOneToOne: false
            referencedRelation: "geo_areas"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "landing_page_contents_city_id_fkey"
            columns: ["city_id"]
            isOneToOne: false
            referencedRelation: "geo_cities"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "landing_page_contents_created_by_profile_id_fkey"
          ...
          {
            foreignKeyName: "landing_page_contents_medical_reviewer_profile_id_fkey"
          ...
          {
            foreignKeyName: "landing_page_contents_published_by_profile_id_fkey"
          ...
          {
            foreignKeyName: "landing_page_contents_reviewed_by_profile_id_fkey"
            columns: ["reviewed_by_profile_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "landing_page_contents_service_id_fkey"
            columns: ["service_id"]
            isOneToOne: false
            referencedRelation: "services"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "landing_page_contents_specialty_id_fkey"
            columns: ["specialty_id"]
            isOneToOne: false
            referencedRelation: "specialties"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "landing_page_contents_updated_by_profile_id_fkey"

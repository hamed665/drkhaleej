...
Add CSP in report-only mode first, then promote to enforcement after route-level verification. Humanity has suffered enough from surprise CSP breakages pretending to be security.

...
- Import-readiness runtime is aligned through PR #964 at baseline commit `bef201d705b3c5a8d40906773b833b9a6ca73a44` (last aligned 2026-07-29).
...
- Migration validation is expected through `0088_import_pharmacy_public_rollback.sql`.
...
- Database foundations validate through `0088_import_pharmacy_public_rollback.sql`.
...
- PRs #936–#964 are the current import-readiness runtime baseline.
- Migration validation passes through `0088_import_pharmacy_public_rollback.sql`.
- Env, seed validation, static RLS, static seed, routes, SEO, typecheck, build and lint gates pass in CI.
- Preview Migration Sync, the isolated P05 regression proof, P06 concurrent rollback authority proof, P07 exact logical recovery proof, P09 hosted/literal completion, P11 authority proof and P13 exact public rollback proof run against the exact PR head with Production disconnected. Index and Sitemap remain separate gates.

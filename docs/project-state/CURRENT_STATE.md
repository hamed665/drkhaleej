...
- Import-readiness runtime is aligned through PR #971 at baseline commit `4cda76704813449719982c5d72b6c28b60788ab0` (last aligned 2026-08-09).
...
- Migration validation is expected through `0093_import_entity_candidate_pipeline.sql`.
...
- Database foundations validate through `0093_import_entity_candidate_pipeline.sql`.
...
- PRs #936–#971 are the current import-readiness runtime baseline.
- Migration validation passes through `0093_import_entity_candidate_pipeline.sql`.

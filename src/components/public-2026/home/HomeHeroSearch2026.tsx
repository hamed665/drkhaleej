...
export function HomeHeroSearch2026({ locale, country, copy }: HomeHeroSearch2026Props) {
  return (
    <section className="dm2026-home-hero relative overflow-hidden py-10 sm:py-14 lg:py-18" aria-labelledby="dm2026-home-title">
      ...
      <div className="mx-auto max-w-5xl text-center">
        ...
        <h1 id="dm2026-home-title" className="dm2026-hero-title mx-auto mt-5 max-w-4xl text-4xl font-bold tracking-[-0.035em] text-dm-text sm:text-5xl lg:text-[3.85rem] lg:leading-[1.02]">
          {copy.hero.title}
        </h1>

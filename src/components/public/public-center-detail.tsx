...
const copyByLocale: Record<PublicCatalogLocale, CenterDetailCopy> = {
  en: {
    ...
    contactUnavailable: 'Contact options are shown only after review. Please confirm details directly before visiting.',
  ...
  ar: {
    ...
    contactUnavailable: 'تظهر خيارات التواصل بعد المراجعة فقط. يرجى تأكيد التفاصيل مباشرة قبل الزيارة.',
    galleryTitle: 'المعرض',

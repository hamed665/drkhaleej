...
import {
  footerCopy,
  resolveLayoutPathnameI18n,
} from "@/components/layout/layout-i18n-copy";
...
export function SiteFooter() {
  ...
  const browseLinks = [
    ...
    {
      href: publicDiscoveryRoute(locale, country, "pharmacies"),
      label: copy.pharmacies,
    },
    {
      href: publicDiscoveryRoute(locale, country, "hospitals"),
  ...
  const disabledProviderItems = [
    copy.reviewedProfile,
    copy.photosGallery,
    copy.offers,
    copy.whatsappCallDirections,
  ] as const;
  const trustItems = [
    copy.publicDiscoveryOnly,
    copy.notMedicalAdvice,
    copy.confirmWithProvider,
    copy.sponsoredVisibility,
  ] as const;

  return (
    <footer
      className="site-footer site-footer--premium dm2026-site-footer"
      role="contentinfo"
      dir={dir}
    >
      <Container className="site-footer__inner dm2026-site-footer__inner">
        ...
        <nav
          className="site-footer__links dm2026-site-footer__links"

export const adminPermissionGroups = [
  ...
  { label: "Content / CMS", permissions: ["content.inventory.read", "content.edit", "faqs.edit", "articles.edit", "seo.edit", "navigation.edit"] },
...
export const adminRoles: Record<AdminRoleKey, { label: string; permissions: readonly AdminPermissionKey[] }> = {
  ...
  operations_manager: { label: "Operations manager", permissions: ["admin.access", "admin.control_center.read", "provider_leads.read", "provider_leads.update_status", "provider_leads.create_draft_center", "draft_centers.read", "draft_centers.update", "draft_centers.taxonomy.update", "draft_centers.workflow.update", "subscriptions.read"] },
  content_editor: { label: "Content editor", permissions: ["admin.access", "admin.control_center.read", "content.inventory.read", "content.edit", "faqs.edit", "articles.edit", "seo.edit", "navigation.edit"] },
  ...
  auditor: { label: "Auditor", permissions: ["admin.access", "admin.control_center.read", "admin.audit.read", "provider_leads.read", "draft_centers.read", "subscriptions.read", "commercial_addons.read"] },
};

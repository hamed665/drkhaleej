...
export const publicDiscoverySlugs = ['doctors', 'dental', 'centers', 'pharmacies', 'beauty', 'pet-clinics', 'pet-shops', 'offers', 'labs', 'services', 'search'] as const;
...
export const localeCountryDiscoveryRoutePattern =
  /^\/(en|ar)\/(om)\/(doctors|dental|centers|pharmacies|beauty|pet-clinics|pet-shops|offers|labs|services|search)(?:\/)?$/;

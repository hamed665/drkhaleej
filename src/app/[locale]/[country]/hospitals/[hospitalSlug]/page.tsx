...
const copyByLocale: Record<SupportedLocale, RouteCopy> = {
  en: {
    ...
    fallbackTitle: "Hospital Profile | DrKhaleej",
    fallbackDescription: "View reviewed public hospital information in Oman on DrKhaleej.",
  ...
  ar: {
    ...
    fallbackTitle: "ملف مستشفى | DrKhaleej",
    fallbackDescription: "اطلع على معلومات عامة مراجعة عن المستشفيات في عُمان عبر DrKhaleej.",
...
export default async function PublicImportedHospitalProfilePage({ params }: { params: Promise<Params> }) {
  const { locale, country, hospitalSlug } = await params;

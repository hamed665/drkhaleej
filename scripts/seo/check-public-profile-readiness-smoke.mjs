...
for (const token of [
  ...
  'function localizedPublicProfileHref',
  'function centerListingHref',
  'item.publicProfilePath',
  'localizedPublicProfileHref(locale, item.defaultCountry, item.publicProfilePath)',
  'return listingHref(locale, item.defaultCountry, \'center\', item.slug)',
  'centerListingHref(props.locale, props.item)',
